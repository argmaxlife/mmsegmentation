...
data_root = "../../deliverables/oilleak-20260615/oilleak-seg-data/mmseg/"
...
# schedule
warmup = 1203 # ceil(number_of_training_images / (2 * 8))
max_iters = 144360  # 120 * ceil(number_of_training_images / (2 * 8))
val_interval = 12030  # 10 * ceil(number_of_training_images / (2 * 8))
